...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/network/descriptions/nat64_synthesize_cidrs.md
    example (Example Usage):     examples/functions/nat64_synthesize_cidrs/function.tf
-->
