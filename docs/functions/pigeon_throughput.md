...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/network/descriptions/pigeon_throughput.md
    example (Example Usage):     examples/functions/pigeon_throughput/function.tf
-->
