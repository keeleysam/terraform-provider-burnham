...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/cryptography/descriptions/x509_fingerprint.md
    example (Example Usage):     examples/functions/x509_fingerprint/function.tf
-->
