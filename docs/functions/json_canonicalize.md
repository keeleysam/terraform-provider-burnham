...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/dataformat/descriptions/json_canonicalize.md
    example (Example Usage):     examples/functions/json_canonicalize/function.tf
-->
