...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/network/descriptions/ip_idunno_encode.md
    example (Example Usage):     examples/functions/ip_idunno_encode/function.tf
-->
