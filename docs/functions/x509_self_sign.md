...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/cryptography/descriptions/x509_self_sign.md
    example (Example Usage):     examples/functions/x509_self_sign/function.tf
-->
