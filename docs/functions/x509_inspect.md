...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/cryptography/descriptions/x509_inspect.md
    example (Example Usage):     examples/functions/x509_inspect/function.tf
-->
