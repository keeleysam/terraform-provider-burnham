...
<!--
  ...
  Edit the source instead:
    prose (MarkdownDescription): internal/provider/transform/descriptions/jmespath_query.md
    example (Example Usage):     examples/functions/jmespath_query/function.tf
-->
