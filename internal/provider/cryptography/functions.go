// Package cryptography provides cryptographic / certificate-handling provider-defined functions: HMAC, HKDF, PEM block decoding, X.509 certificate inspection / fingerprinting / deterministic self-signing, PKCS #10 CSR inspection, deterministic ECDSA P-256 key derivation, CMS/PKCS#7 signing, and generic ASN.1 BER/DER tree decoding.
