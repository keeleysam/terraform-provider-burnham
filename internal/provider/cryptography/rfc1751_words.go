// Code generated from RFC 1751 Appendix (the "Wp[2048][4]" dictionary). DO NOT EDIT.
// Verbatim 2048-word table; the only authoritative source is the RFC itself.

package cryptography

// rfc1751Words is the RFC 1751 dictionary: index (0..2047) → word. An 11-bit
// field selects one entry, so exactly 2048 words are required.
var rfc1751Words = [2048]string{
