...
`timestamp` accepts any RFC 3339 / RFC 3339 Nano timestamp, for example `"2026-05-08T12:00:00Z"`. Sub-millisecond precision is truncated; the v7 spec only carries milliseconds. The value must fall in the 48-bit Unix-millisecond range (on or after `1970-01-01T00:00:00Z`, before ~+10889 AD); earlier or far-future times are rejected.
